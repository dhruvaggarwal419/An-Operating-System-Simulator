...
page = st.sidebar.radio("Go to", ["Process Scheduling", "Disk Scheduling", "Memory Management (Visualization - Contiguous)", "Deadlock Detection", "Page Replacement Algorithms Simulator"])
